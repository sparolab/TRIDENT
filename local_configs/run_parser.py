...
class MainParser():
    ...
    def __init__(self):
        ...
        self.parser = argparse.ArgumentParser(description= "This is Initial Option for YGM Joint-ID"
    ...
    def initialize(self):
        ...
        # Online eval
        self.parser.add_argument('--do_online_eval', action='store_true', help='if set, perform online eval in every eval_freq steps')
